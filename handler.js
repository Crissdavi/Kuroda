...
global.dfail = (type, m, conn) => {
    let msg = {
        rowner: '*SOLO PARA DESARROLLADORES* • ESTE COMANDO ES SOLO PARA DESARROLLADORES DEL BOT',
        owner: '*SOLO PARA PROPIETARIOS* • ESTE COMANDO ES SOLO PARA PROPIETARIOS DEL BOT',
        mods: '*SOLO PARA MODERADORES* • ESTE COMANDO ES SOLO PARA MODERADORES DEL BOT',
        premium: '*SOLO PARA USUARIOS PREMIUM* • ESTE COMANDO ES SOLO PARA USUARIOS PREMIUM',
        group: '*SOLO EN CHATS DE GRUPO* • ESTE COMANDO SOLO FUNCIONA EN CHATS DE GRUPO',
        private: '*SOLO EN CHATS PRIVADOS* • ESTE COMANDO SOLO FUNCIONA EN CHATS PRIVADOS',
        admin: '*SOLO PARA ADMINISTRADORES* • ESTE COMANDO ES SOLO PARA ADMINISTRADORES DEL GRUPO',
        botAdmin: '*SOLO CUANDO EL BOT ES ADMINISTRADOR* • ESTE COMANDO SOLO SE PUEDE USAR CUANDO EL BOT ES ADMINISTRADOR',
        unreg: '*NO ESTÁS REGISTRADO AÚN* • ESCRIBE .daftar PARA USAR ESTA FUNCIÓN',
        restrict: '*RESTRICCIÓN NO ACTIVADA* • RESTRICCIÓN NO ACTIVADA EN ESTE CHAT',
    }[type]
