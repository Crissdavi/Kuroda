...
function logMessage(me, name, m, chat, filesize, sender, user) {
  console.log(`╭━━━━━━･❪ Genesis-Ultra ❫ ･━━━━━━
┃░⃝ᩘֵ👤ᩙᩖ ${chalk.redBright('%s')}
┃░⃝ᩘֵ⏰ᩙᩖ ${chalk.black(chalk.bgYellow('%s'))}
┃░⃝ᩘֵ📊ᩙᩖ ${chalk.magenta('%s [%s %sB]')}
┃░⃝ᩘֵ📤ᩙᩖ ${chalk.green('%s')}
┃░⃝ᩘֵ📪ᩙᩖ ${chalk.yellow('%s%s')}
┃░⃝ᩘֵ📥ᩙᩖ ${chalk.green('%s')}
┃░⃝ᩘֵ💬ᩙᩖ ${chalk.black(chalk.bgYellow('%s'))}
╰•°• ✾ •°••°• ✾ •°••°• ✾ •°•°••°• ✾
${chalk.cyan('%s')}
