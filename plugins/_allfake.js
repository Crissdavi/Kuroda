...
newsletterJid: '120363210705976689@newsletter',
    ...
    caption: `${wm} | 2022 - 2025`
        ...
        global.ftextt = {
            ...
            message: {
                "extendedTextMessage": {
                    "text": wm,
                    "title": wm,
                    'jpegThumbnail': fs.readFileSync('./src/catalogo.png')
                }
            }
        }
        ...
        global.fliveLoc = {
            ...
            message: { "liveLocationMessage": { "caption": "by : WH MODS DEV", "h": `${wm}`, 'jpegThumbnail': fs.readFileSync('./src/catalogo.png') } }
        }
        ...
        global.fliveLoc2 = {
            ...
            message: { "liveLocationMessage": { "title": "WH MODS DEV", "h": wm, 'jpegThumbnail': fs.readFileSync('./src/catalogo.png') } }
        }
            ...
            message: {
                "productMessage": {
                    "product": {
                        "productImage": {
                            "mimetype": "image/jpeg",
                            "jpegThumbnail": fs.readFileSync('./src/catalogo.png') //Gambarnye
                        },
                        "title": wm, 
